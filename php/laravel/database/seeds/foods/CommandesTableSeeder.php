...
class CommandesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        {
            DB::connection('mysql')->table('commandes')->insert([
                'id' => $commande[0],
                'client_id' => $commande[1],
                'employee_id' => $commande[2],
                'date_commande' => date('Y-m-d', strtotime($commande[3])),
                'date_requise' => date('Y-m-d', strtotime($commande[4])),
                'date_livraison' => date('Y-m-d', strtotime($commande[5])),
                'expediteur_id' => $commande[6],
                'fret' => $commande[7],
                'nom_expediteur' => $commande[8],
                'adresse_livraison' => $commande[9],
                'ville_livraison' => $commande[10],
