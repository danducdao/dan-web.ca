...
module.exports = function(app){
    ...
    {
         var citiesFound = cities.filter(data => data.country.indexOf(req.query.abbrPays) !== -1);
         var returnCities = [];
    ...
    {
          var returnRegions = [];
          var country = regions.filter(data => data.countryShortCode.indexOf(req.query.abbrPays) !== -1)[0];
