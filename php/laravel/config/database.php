    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'password' => env('DB_PASSWORD', 'asiavn73'),
        ...
        'mysql2' => [
            ...
            'database' => env('DB_DATABASE_SECOND', 'music'),
            'username' => env('DB_USERNAME_SECOND', 'root'),
            'password' => env('DB_PASSWORD_SECOND','asiavn73'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'mysql3' => [
            ...
            'database' => env('DB_DATABASE_THIRD', 'movie'),
            'username' => env('DB_USERNAME_THIRD', 'root'),
            'password' => env('DB_PASSWORD_THIRD', 'asiavn73'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'mysql4' => [
            ...
            'password' => env('DB_PASSWORD_FOUR', 'asiavn73'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
