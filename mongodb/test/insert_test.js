...
describe("Sauvegarder de données dans les collections", function() {
  ...
  it("Sauvegarder de données dans collection employee", function(done) {
    E1 = new Employee({
      ...
      photo: "",
      note:
        "L'éducation inclut un BA en psychologie de l'université d'état du Colorado en 1970. Elle a également accompli l'art de l'appel froid. Nancy est membre de Toastmasters International.",
      dateCreation: today,
      active: true
    });
    E1.save()
      ...
      .then(function() {
        ...
        E3 = new Employee({
          ...
          photo: "",
          note:
            "Janet détient un baccalauréat en chimie du Boston College (1984). Elle a également complété un programme de certificat en gestion de la vente au détail de produits alimentaires. Janet a été embauchée comme adjointe aux ventes en 1991 et promue au poste de représentante des ventes en février 1992.",
          dateCreation: today,
          active: true
        });
        return E3.save();
      ...
      .then(function() {
        ...
        E4 = new Employee({
          ...
          photo: "",
          note:
            "Steven Buchanan est diplômé de l'Université St. Andrews, en Écosse, avec un BSC en 1976. Après avoir rejoint l'entreprise en 1992, il a passé 6 mois dans un programme d'orientation au bureau de Seattle avant de retourner à son poste permanent à Londres. . Il a été promu au poste de directeur des ventes en mars 1993. M. Buchanan a suivi les cours «Successful Telemarketing» et «International Sales Management». Il parle couramment le français.",
          dateCreation: today,
          active: true
        });
        return E4.save();
      ...
      .then(function() {
        ...
        E5 = new Employee({
          ...
          photo: "",
          note:
            "Margaret détient un baccalauréat en littérature anglaise du Concordia College (1958) et une maîtrise de l'American Institute of Culinary Arts (1966). Elle a été affectée temporairement au bureau de Londres de juillet à novembre 1992.",
          dateCreation: today,
          active: true
        });
        return E5.save();
  ...
  it("Sauvegarder de données dans collection admin", function(done) {
    var admin = new Admin({
      ...
      confirmPassword:
        "sha1$147388cc$1$f397d36f29901b7f6bf26e05ab0672f2de7b234e",
      dateCreation: today,
      active: true
    });
    admin
