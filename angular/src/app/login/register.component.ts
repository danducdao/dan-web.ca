...
export class RegisterComponent implements OnInit {
  ...
  public myDatePickerOptions: IMyDpOptions = { dateFormat: 'yyyy-mm-dd',editableDateField:false };
  ...
  selectedPays()
  {
      if(!this.employee.pays)
          return;
      this._googleMapService.getVilles(this.employee.pays).subscribe(res => this.villesOpt = res);
      this._googleMapService.getRegions(this.employee.pays).subscribe(res => this.regionsOpt = res);
  }
  ...
  onSubmit()
  {
      ...
      this._employeeService.saveEmployee(this.employee,this.admin).subscribe(res => this.callback(res));
  }
