...
class ProduitsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        {
            DB::connection('mysql')->table('produits')->insert([
                'id' => $produit[0],
                'nom' => $produit[1],
                'fournisseur_id' => $produit[2],
                'categorie_id' => $produit[3],
                'quantiteParUnite'=> $produit[4],
                'prix' => $produit[5],
                'quantiteEnStock' => $produit[6],
                'quantiteCommande' => $produit[7],
